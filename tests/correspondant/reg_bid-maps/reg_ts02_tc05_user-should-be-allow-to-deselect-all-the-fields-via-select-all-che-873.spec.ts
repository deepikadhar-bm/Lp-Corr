...
test.describe('REG_Bid Maps', () => {
  ...
  test('REG_TS02_TC05_User should be allow to deselect all the Fields via \\\"Select all\\\" checkbox', async ({ page }) => {
    ...
    await page.locator("//input[@type=\"checkbox\" and contains(@class, 'custom-control-input')]").uncheck();
