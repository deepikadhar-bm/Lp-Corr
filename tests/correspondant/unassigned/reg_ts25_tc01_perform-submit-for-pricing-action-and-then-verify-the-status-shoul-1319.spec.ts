...
test.describe('Unassigned', () => {
  ...
  test('REG_TS25_TC01_Perform submit for pricing action, and then verify the status should be updated to pricing in progress followed by submit for pricing.', async ({ page }) => {
