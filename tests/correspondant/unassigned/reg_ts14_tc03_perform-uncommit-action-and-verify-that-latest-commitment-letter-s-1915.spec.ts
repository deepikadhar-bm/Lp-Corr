...
test.describe('Unassigned', () => {
  ...
  test('REG_TS14_TC03_Perform uncommit action and verify that latest commitment letter should be displayed with the latest value', async ({ page }) => {
    // Prerequisite: REG_TS14_TC02.1_Perform add to commit action and verify that latest commitment letter should be disp
    ...
    vars["CommitmentRowsCount"] = String(await page.locator("//div[normalize-space(text())=\"Commit. ID\"]//following-sibling::h5[normalize-space(text())=\"$|CommitmentID|\"]//following::table[1]//tbody//tr[@role=\"row\"]").count());
