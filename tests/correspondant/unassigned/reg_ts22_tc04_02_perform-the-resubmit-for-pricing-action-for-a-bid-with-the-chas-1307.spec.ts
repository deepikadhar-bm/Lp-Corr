...
test.describe('Unassigned', () => {
  ...
  test('REG_TS22_TC04_02_Perform the resubmit for pricing action for a bid with the Chase execution type, and validate all the values in the resubmitted record . (Target: Submit today, status :Expired)', async ({ page }) => {
    // Prerequisite: REG_TS22_TC04_01.1_Perform the resubmit for pricing action for a bid with the Chase execution type, 
