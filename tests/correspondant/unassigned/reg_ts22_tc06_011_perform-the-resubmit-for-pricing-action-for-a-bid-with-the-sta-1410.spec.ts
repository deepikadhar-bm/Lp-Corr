...
test.describe('Unassigned', () => {
  ...
  test('REG_TS22_TC06_01.1_Perform the resubmit for pricing action for a bid with the Standard and chase type, and verify the values in the resubmitted record, ensuring validation of table data, loan details,', async ({ page }) => {
    // Prerequisite: REG_TS22_TC06_01_Perform the resubmit for pricing action for a bid with the Standard and chase type,
    ...
    await expect(page.locator("//span[text()=\"Continue\"]/..")).toBeEnabled();
