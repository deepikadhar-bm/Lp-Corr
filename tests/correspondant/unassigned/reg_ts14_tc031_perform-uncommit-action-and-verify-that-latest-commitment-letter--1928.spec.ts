...
test.describe('Unassigned', () => {
  ...
  test('REG_TS14_TC03.1_Perform uncommit action and verify that latest commitment letter should be displayed with the latest value', async ({ page }) => {
    // Prerequisite: REG_TS14_TC03_Perform uncommit action and verify that latest commitment letter should be displayed w
