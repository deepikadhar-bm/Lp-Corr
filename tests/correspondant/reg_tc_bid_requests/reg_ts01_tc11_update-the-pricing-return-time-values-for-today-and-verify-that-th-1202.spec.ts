...
test.describe('REG_TC_Bid_Requests', () => {
  ...
  test('REG_TS01_TC11_Update the pricing return time values for today and verify that the same should be displayed in the dropdown list for today.', async ({ page }) => {
