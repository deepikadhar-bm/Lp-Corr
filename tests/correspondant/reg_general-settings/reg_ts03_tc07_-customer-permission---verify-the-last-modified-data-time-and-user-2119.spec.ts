...
test.describe('REG_General Settings', () => {
  ...
  test('REG_TS03_TC07_ Customer Permission - Verify the Last Modified Data, Time and User get displayed in the Right Corner of the Page.', async ({ page }) => {
    // Prerequisite: REG_TS03_TC03_Customer Permission - Verify the edit permission action.
    ...
    // })();
    await expect(page.locator("(//td[@data-title=\"Last Modified\"])[1]")).toContainText(vars["CurrentLocalTimeList"]);
    await expect(page.locator("(//td[@data-title=\"Modified By\"])[1]")).toContainText("testsigma_internal");
  });
});
