...
export const correspondantEnv: EnvironmentConfig = {
  ...
  credentials: {
    username: process.env.CORR_USERNAME || 'testsigma_internal',
    password: process.env.CORR_PASSWORD || 'Welcome@123',
    internalPassword: process.env.CORR_INTERNAL_PASSWORD || 'Welcome@123',
  },
};
